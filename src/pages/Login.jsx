...
function Login() {
    ...
    return (
        <div className='py-28 bg-gray-100 h-screen'>
            <p className='text-3xl text-center font-semibold mb-5'>Login to accsess your <span className='text-blue-500'>User Dashboard</span> </p>
            <div className="p-5 sm:py-16 bg-white relative overflow-x-auto shadow-md shadow-blue-100 rounded-lg lg:w-1/2 sm:w-3/4 w-11/12 m-auto">
                ...
                <form className='sm:w-3/4 m-auto' onSubmit={handleSubmit}>
                    ...
                    <div className="my-3">
                        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder='Email' className="w-full rounded-lg p-3 mt-2  border border-gray-300 focus:outline-blue-500 focus:outline-1" />
